...
export class CategoriesComponent implements OnInit, AfterViewInit {
 ...
 data:Categories[]=[
   {id:1,name:"Mandi",imgUrl:"../../../../assets/dynamicimg/mandi.jpeg",avilable:true,price:500},
   {id:2,name:"Staters",imgUrl:"../../../../assets/dynamicimg/mandi.jpeg",avilable:true,price:500},
   {id:3,name:"Juices",imgUrl:"../../../../assets/dynamicimg/mandi.jpeg",avilable:false,price:500},
   {id:4,name:"MockTails",imgUrl:"../../../../assets/dynamicimg/mandi.jpeg",avilable:false,price:500}
  ];
  ...
  navigateToDetail(categoryName:any){
    this.router.navigate(['foodView'])
  }
  initMap() {
    
     this.map = L.map('map').setView([13.7496064,79.6894940], 20);
     // Add an OpenStreetMap tile layer
     L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
      attribution:'Arabic Mandi : 13.7496064 , 79.6894940'
     }).addTo(this.map);
     const marker = L.marker([13.7496064,79.6894940]).addTo(this.map);
    // initial popup
